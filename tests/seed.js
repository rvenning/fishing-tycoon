...
// than an unlucky shuffle.
//
// The engine itself never calls Math.random — every shuffle comes from
// js/rng.js — but the BOTS make their own choices, and those need seeding too.
(function () {
  ...
  // unseeded one. Anything random in a bot must come through here instead, or
  // two runs of the same configuration are not comparable.
  globalThis.__rand = function () { return Math.random(); };
  globalThis.__reseed(20260818);
})();
